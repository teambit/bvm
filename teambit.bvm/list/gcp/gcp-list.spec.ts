...
describe('GcpList', () => {
  it('should return the correct URL on Windows', async () => {
    ...
    const gcpList = GcpList.create(ReleaseTypeFilter.NIGHTLY, 'Windows_NT', 'x64');
  ...
  it('should return the correct URL on Linux', async () => {
    ...
    const gcpList = GcpList.create(ReleaseTypeFilter.NIGHTLY, 'Linux', 'x64');
    const list = await gcpList.list();
  ...
  it('should return the correct URL on macOS', async () => {
    ...
    const gcpList = GcpList.create(ReleaseTypeFilter.NIGHTLY, 'Darwin', 'x64');
    const list = await gcpList.list();
  ...
  it('should return the correct URL on macOS with arm64 CPU', async () => {
    ...
    const gcpList = GcpList.create(ReleaseTypeFilter.NIGHTLY, 'Darwin', 'arm64');
    const list = await gcpList.list();
  ...
  it('should return only stable releases', async () => {
    ...
    const gcpList = GcpList.create(ReleaseTypeFilter.STABLE, 'Windows_NT', 'x64');
    const list = await gcpList.list();
